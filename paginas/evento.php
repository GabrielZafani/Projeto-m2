...
<h2 class="textC text-center" id="ventre-de-nossa-senhora"><strong>Ventre de nossa senhora</strong></h2>
    ...
    <div>
        <h3 class="info textP text-start"><strong>Informações!</strong></h3>
        <ul class="textP text-start">
            <li>
            ...
            <li><p><i class="fa-solid fa-circle-arrow-right" style="color: #DAA520;"></i><strong> O que levar:</strong></p>
                <ul>
                    ...
                    <li>
                        <p><i class="fa-solid fa-tshirt" style="color: #DAA520;"></i> Roupa de cama e banho </p>
                    </li>
                    <li>
                        <p><i class="fa-solid fa-utensils" style="color: #DAA520;"></i> Pratinho para partilha </p>
                    </li>
